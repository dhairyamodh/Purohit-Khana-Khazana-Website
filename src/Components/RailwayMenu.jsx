...
const RailwayMenu = () => {
  ...
  return (
    <>
      <Layout title={"RailwayMenu Purohit-KhanaKhazana"}>
      ...
      <section className="light-background">
        <div className="container">
          ...
          <p className="text-center" style={{ color: "brown" }}>
            5 Ghee Roti (125gms) ,1 Paneer Sabji (100gms) ,1 Veg Sabji (100gms)
            , 1 Dal fry (100gms) 1 Jeera Rice (100 gms) , 1 Curd (100 gms) Or 1
            Butter Milk (200ml) ,1 Sweet (25gms) , 1 Papad (Small), Salad,
            (Include 5% GST)
          </p>
          <div className="row">
